# -*- coding: utf-8 -*-
"""DenseNet169_n_estimator.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-mOxGjTERdQz3tnN6cEkRncBUnHiGzyv
...
for lr in [10, 20, 50, 100, 200, 500, 1000, 2000, 5000]:
    ...
    result[lr]["Sensitivity"] = result[lr]["confusion matrix"][0,0] / (result[lr]["confusion matrix"][0,0] + result[lr]["confusion matrix"][0,1])
    result[lr]["Specifity"] = result[lr]["confusion matrix"][1,1] / (result[lr]["confusion matrix"][1,0] + result[lr]["confusion matrix"][1,1])
    ...
    print(f"\nSpecifity : ", result[lr]["Specifity"])
    print(f"\nSensitivity : ", result[lr]["Sensitivity"])
